...
//   boxGeo,
//   creatPageMaterials("/data/admin/setup/company_settings.png")
// );
// box1.position.set(32, 0, -80);
// box1.rotation.set(0, 25 * degToRad, 0);
// box1.userData =
...
//   boxGeo,
//   creatPageMaterials("/data/admin/setup/ui_settings.png")
// );
// box2.position.set(50, 0, 0);
// box2.userData = "https://help.salesforce.com/s/articleView?id=sf.customize_ui_settings.htm&type=5";
// scene.add(box2);

// const box3 = new THREE.Mesh(
//   boxGeo,
//   creatPageMaterials("/data/admin/setup/user_and_security_controls.png")
// );
// box3.position.set(32, 0, 80);
// box3.rotation.set(0, -25 * degToRad, 0);
// box3.userData =
...
// let allHoverableObjects = [box1, box2, box3, creditBox];
...
const lessonData = new Map([
  ["/data/admin/setup/company_settings.png", "https://help.salesforce.com/s/articleView?id=sf.company_information_fields.htm&type=5"],
  ["/data/admin/setup/ui_settings.png", "https://help.salesforce.com/s/articleView?id=sf.customize_ui_settings.htm&type=5"],
  ["/data/admin/setup/user_and_security_controls.png", "https://help.salesforce.com/s/articleView?id=sf.security_data_access_mgmt.htm&type=5"]
]);

import { createLessonPage } from "/functions";
